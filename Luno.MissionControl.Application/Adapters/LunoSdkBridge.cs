...
namespace Luno.MissionControl.Application.Adapters;

/// <summary>
/// [TEMPORARY BRIDGE] Wraps the Luno SDK to satisfy the new domain interfaces.
/// These will be moved to the Infrastructure project in Phase 3.
/// </summary>
public sealed class LunoSdkBridge(ILunoClient lunoClient) : ILunoTrader, ILunoMarketData
{
    ...
    {
        // Re-calculate or map back to SDK types - this is exactly why we want this in a bridge!
